...
public final class GattServer {
    ...
    public void addService(ServiceSettings settings) {
        BluetoothGattService service = new BluetoothGattService(settings.getServiceUuid(), settings.getServiceType());
        List<ServiceProfile> profiles = settings.getServiceProfiles();
